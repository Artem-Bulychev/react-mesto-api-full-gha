  ...
  const elementLikeButton = `elements__like ${
    ...
    return(
          <li className="elements__item">
            ...
            <img className="elements__photo" onClick={handleCardClick} src={card.link} alt={card.name} />
            <div className="elements__text">
              <h2 className="elements__title">{card.name}</h2>
              <div className="elements__card">
                <button className={elementLikeButton} type="button" onClick={handleLikeClick}></button>
